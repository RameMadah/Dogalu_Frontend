...
<style scoped>
:root {
  --dark-color: hsl(var(--accent3Shade2), 100%, 9%);
  --light-color: hsl(var(--accent3Shade4), 95%, 98%);
  --base: hsl(var(--bg-gradient), 95%, 50%);
  --complimentary1: hsl(var(--light-color), 95%, 50%);
  --complimentary2: hsl(var(--accent3Shade3), 95%, 50%);

  --font-family: "Poppins", system-ui;

  --bg-gradient: linear-gradient(
    to bottom,
    hsl(var(--accent3Shade3), 95%, 99%),
    hsl(var(--light-color), 95%, 84%)
  );
}
...
.overlay__btn {
  ...
  outline-color: hsl(var(--light-color), 95%, 50%);
}
