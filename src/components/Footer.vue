      ...
      <div class="footer-custom">
        <div class="footer-lists">
          <div class="footer-list-wrap">
            ...
            <ul class="ftr-links-sub">
              <li><a href="http://www.art.fr" rel="nofollow">Deutschland</a></li>
              <li><a href="https://www.art.co.uk" rel="nofollow">Berlin</a></li>
            </ul>
          </div>
          <!--/.footer-list-wrap-->
          <div class="footer-list-wrap">
            <h6 class="ftr-hdr">Kunde Dienst</h6>
            <ul class="ftr-links-sub">
              <li><a href="/help/talktous.html" rel="nofollow">Kontaktieren Sie uns</a></li>
              <li><a href="/help/placingorders.html" rel="nofollow">Trainer beauftragen</a></li>
              <li><a href="/help/shipping.html" rel="nofollow">Lektionen &amp; Tips</a></li>
              <li><a href="/help/shippingreturns.html" rel="nofollow">Chat</a></li>
              <li><a href="/help/international-shipping.html" rel="nofollow">local </a></li>
              <li><a href="/~/egift-cards/" rel="nofollow">Geschenkkarten</a></li>
              <li><a href="/help/faq.html" rel="nofollow">FAQs</a></li>
            </ul>
          </div>
          <div class="footer-list-wrap">
            <h6 class="ftr-hdr">Über Dogalu.com</h6>
            <ul class="ftr-links-sub">
              <li><a href="/asp/aboutus/default-asp/_/posters.htm" rel="nofollow">Unser App</a></li>
              <li><a href="http://corporate.art.com/careers" rel="nofollow">Tätigkeiten</a></li>
              <li><a href="/asp/landing/artistrising" rel="nofollow">Galerie</a></li>
              <li><a href="/~/art-for-business" rel="nofollow">Business &amp; Trade Sales</a></li>
              <li><a href="http://affiliates.art.com/index.aspx" rel="nofollow">fun Program</a></li>
              <li><a href="/catalog" rel="nofollow"><strong>kategorie</strong></a></li>
        ...
        <div class="footer-email">
          <h6 class="ftr-hdr">Registrieren Sie sich für exklusive Angebote und Inspirationen</h6>
          <div id="ftr-email" class="ftr-email-form">
            <form id="ftrEmailForm" method="post" action="http://em.art.com/pub/rf">
              ...
              <input type="text" name="email_address_" id="ftrEmailInput" class="input" placeholder="E-Mail Adresse" />
              <!--
                  -->
        ...
        <div class="footer-legal">
          ...
          <p>Dogalu.com, You+Art und Photos [to] Art sind Marken oder eingetragene Marken von Dogalu.com Inc.</p>
          <p>Verschiedene Aspekte dieser Website sind durch das erteilte Dogs Nr. 7,973,796 und andere anhängige Patentanmeldungen abgedeckt.</p>
        </div>
        <!--/.footer-legal-->
        <div class="footer-payment">
          <ul>
            <li class="ftr-stella">
              <span title="Stella Service" onclick="jump()"> </span>
            </li>
            <li>
